// Simple test script for Bitbucket integration plugin
const { BitbucketManager } = require("./dist/bitbucket-manager");

console.log("Testing Bitbucket integration plugin...");

// Test 1: Check if the BitbucketManager class is properly defined
console.log("\n1. Testing BitbucketManager class definition...");
try {
  const config = {
    apiToken: "mock-api-token",
    username: "mock-username",
  };
  const bitbucketManager = new BitbucketManager(config);
  console.log("✅ BitbucketManager class is properly defined");
  console.log("✅ BitbucketManager instance created successfully");

  // Test 2: Check if all required methods exist
  console.log("\n2. Testing BitbucketManager methods...");
  ...
  for (const method of requiredMethods) {
    if (typeof bitbucketManager[method] === "function") {
  ...
  console.log("\nNote: API functionality tests require valid Bitbucket credentials.");
